...
const AlertPill = ({ count, label, color, icon: Icon }) => {
    ...
    return (
        <div
            className={`flex items-center justify-center lg:justify-start gap-1.5 px-3 py-1.5 rounded-xl border text-[11px] font-bold uppercase tracking-wider w-full lg:w-auto ${
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto shrink-0">
                    ...
                    >
                        <RefreshCw
                            size={13}
                            className={
                                isDashboardLoading || isMembersLoading
                                    ? 'animate-spin'
                                    : ''
                            }
                        />
            ...
            {hasAlerts && (
                ...
                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap gap-2.5 w-full">
                        ...
                        <AlertPill
                            count={deniedCount}
                            label="denied members"
                            color="red"
                            icon={CircleAlert}
                        />

                        <AlertPill
                            count={unpaidMealCount}
                            label="unpaid meal bills"
                            color="red"
                            icon={IndianRupee}
                        />

                        <AlertPill
                            count={unpaidGasCount}
                            label="unpaid gas bills"
                            color="red"
                            icon={ChartPie}
                        />
                    </div>
                    ...
                    <div className="flex items-start sm:items-center gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                                No pending approvals or unpaid dues for the{' '}
