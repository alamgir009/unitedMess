                    ...
                    <li key={activity.id}>
                        <div className="relative pb-8">
                            {activityIdx !== activities.length - 1 ? (
                                <span className="absolute left-4 top-4 -ml-px h-full w-0.5 bg-gray-200 dark:bg-slate-800" aria-hidden="true" />
                            ) : null}
                            <div className="relative flex space-x-3">
                                <div>
                                    <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white dark:ring-slate-900 transition-colors duration-300 ${activity.type === 'meal' ? 'bg-orange-500' :
                                ...
                                <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                    <div>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 transition-colors">
                                            {activity.content} <span className="font-medium text-gray-900 dark:text-gray-50 transition-colors">{activity.target}</span>
                                        </p>
                                    </div>
