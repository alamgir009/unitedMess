...
export const FOODS = [
    ...
    { id: 15, name: 'Mutton Curry',     category: 'Special',   cal: 280, prep: '1.30 hr', rating: 4.8, tag: null,    description: 'Juicy tender Mutton cooked in sweetened milk with ghee, raisins, and nuts. A celebration in every bite.',                                        image: 'https://i.pinimg.com/1200x/51/14/43/51144306d01edccf668f3be1817ea378.jpg' },
    { id: 16, name: 'Sorse Ilsh',       category: 'Special',   cal: 90,  prep: '45 min', rating: 4.7, tag: null,          description: 'Ilish mach in a mustard and Red chilli sauce — Benagli treasure on every mess table.',                                                      image: 'https://i.pinimg.com/1200x/d0/37/2d/d0372da656edeb4c4e0fd2ea2a68d84a.jpg' },
];