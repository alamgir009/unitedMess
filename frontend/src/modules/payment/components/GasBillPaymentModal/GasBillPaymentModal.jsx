...
const SuccessView = ({ onClose }) => (
  <div className="text-center py-8 space-y-6">
    <div className="w-16 h-16 rounded-xl bg-success/10 text-success flex items-center justify-center mx-auto">
