...
/* ------------------------------------------------------------------ */
/*  EditModal – buttery 60 fps on mobile, refined on desktop          */
/* ------------------------------------------------------------------ */
            ...
            >
              ...
              <div
                className={[
                  ...
                  "bg-blue-500/20 rounded-full pointer-events-none",
              ...
              <div className="relative z-10 flex items-center justify-between px-6 pt-5 pb-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, hsl(217,91%,60%) 0%, hsl(217,91%,48%) 100%)",
                    }}
                  />
              ...
              <div className="relative z-10 px-6 py-5 max-h-[82vh] overflow-y-auto">
                <div
                  className={[
                    ...
                    "w-64 h-64 bg-blue-500/5 rounded-full pointer-events-none -z-10",
